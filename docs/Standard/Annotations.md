...
You can use AdaptFM to create annotations to use as labels for fine-tuning models. Before fine-tuning, first make sure you have [installed](../../README.md/#Installation) and [tested](./Testing-Models.md) the model, since fine-tuning might not be needed.
