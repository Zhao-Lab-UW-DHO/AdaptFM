...
1. Follow our [testing](Standard/Testing-Models.md) instructions try out model inference with CellposeSAM and MicroSAM on organoid datasets (BBBC024, BBBC027, or Organoids_Nuclear_Channel), and SAM-Med-3D on radiologic data (one of RESECT or imageTBAD).
