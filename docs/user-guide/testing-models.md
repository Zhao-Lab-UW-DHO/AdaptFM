...
**Follow instructions in the above links to launch inference for different models.** Model inference follows the same general steps. Begin by selecting "Segmentation Models" --> "Inference" in the top of Napari.
