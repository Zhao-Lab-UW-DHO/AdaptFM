...
>**Storage Consideration:** AdaptFM creates model-specific copies of training data; if storage is limited, consider deleting these copies after training has completed.
