...
AdaptFM supports GUI-based inference for various models. First, make sure you have [installed the tool](../../README.md/#Installation and Setup)
...
3. "Select dataset folder" --> raw images you would like to predict using the model
4. "Select model checkpoint" --> you can optionally select the checkpoint for a trained model. This is not required for MicroSAM, CellposeSAM, or SAM-Med-3D. It is required for nnUNetv2 and SSVT.
